...
!
!   /SDAYCL/ Daily observed climatological fields over sea
...
!
!   /SDAYAN/ Daily observed SST anomaly
      common /SDAYAN/ sstan_ob
      real sstan_ob(ngp)                ! observed sst anomaly 
!
!   /SDAYCL_OM/ Daily climatological fields from ocean model
      common /SDAYCL_OM/ sstcl_om
      real sstcl_om(ngp)                ! ocean model clim. SST 
!
!   /SVAR_AM/ Sea sfc. fields used by atmospheric model
...
!
!   /SVAR_OM/ Sea sfc. fields from ocean/sea-ice model
...
!
!   /WOBSST/ Weight for obs. SST anomaly in coupled runs
